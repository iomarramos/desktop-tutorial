...
function upsertGoogleUser({ googleId, email, name, avatarUrl, source }) {
...
function adminSignupSourceCounts() {
  const rows = signupSourceCountsStmt.all();
  const counts = { web: 0, local: 0 };
  for (const row of rows) {
